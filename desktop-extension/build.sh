...
#
#   bash desktop-extension/build.sh    ->  desktop-extension/bluesky-<version>.mcpb
set -euo pipefail
...
npx -y @anthropic-ai/mcpb@latest pack "$build" "$root/desktop-extension/bluesky-$version.mcpb"

echo
echo "Built desktop-extension/bluesky-$version.mcpb"
